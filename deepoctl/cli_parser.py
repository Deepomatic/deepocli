...
def parse_args(args):
    ...
    for parser in parsers:
        ...
        parser.add_argument('--draw_scores', help="Draw scores if draw output", action="store_true")
        parser.add_argument('--draw_labels', help="Draw labels if draw output", action="store_true")
        parser.add_argument('--blur_method', help="Blur method if blur output", default="pixel")
        parser.add_argument('--blur_strength', help="Blur method if blur output", default=10)
