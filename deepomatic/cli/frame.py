...
class Frame(object):
    ...
    def __str__(self):
        return '<Frame name={} filename={} frame_number={} video_frame_index={} absolute_video_frame_index={} inference_async_result={}>'.format(
            self.name, self.filename, self.frame_number, self.video_frame_index, self.absolute_video_frame_index, self.inference_async_result)
